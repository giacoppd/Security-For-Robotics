...
if("TRUE" STREQUAL "TRUE")
  set(malpac2_SOURCE_PREFIX /home/dominic/SP/Security-For-Robotics/malpac2/src/malpac2)
  set(malpac2_DEVEL_PREFIX /home/dominic/SP/Security-For-Robotics/malpac2/devel)
  set(malpac2_INSTALL_PREFIX "")
  set(malpac2_PREFIX ${malpac2_DEVEL_PREFIX})
else()
  set(malpac2_SOURCE_PREFIX "")
  set(malpac2_DEVEL_PREFIX "")
  set(malpac2_INSTALL_PREFIX /home/dominic/SP/Security-For-Robotics/malpac2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'malpac2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dominic/SP/Security-For-Robotics/malpac2/src/malpac2/${idir}'.  Ask the maintainer 'dominic <dominic@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dominic/SP/Security-For-Robotics/malpac2/devel/lib;/opt/ros/indigo/lib)
