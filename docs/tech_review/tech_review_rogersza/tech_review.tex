...
spectrum\cite{HakDaSpectrum}. This means that communication packets for the drone is being sent and received out in the
...
Ubuntu Snappy Core, enabling us to use ROS\cite{PixHawk}.
