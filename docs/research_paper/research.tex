...
Either way, if one's robot is dependent on wireless networking, it is going to be downed for a bit.

\subsection{Malpac 4}
This one is actually our Client, Vee's package. It does a very slow recursive implementation of the calculation of Fibonacci
