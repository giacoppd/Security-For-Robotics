...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'malpac7' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dominic/Documents/senior/Security-For-Robotics/ros_packages/malpac7/install/${idir}'.  Ask the maintainer 'dominic <dominic@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dominic/Documents/senior/Security-For-Robotics/ros_packages/malpac7/install/lib;/opt/ros/indigo/lib)
